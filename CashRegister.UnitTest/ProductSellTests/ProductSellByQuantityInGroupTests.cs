...
namespace CashRegister.UnitTest.ProductSellTests
{
    /// <summary>
    /// Summary description for ProductSellByQuantityInGroupTests
    /// </summary>
    [TestClass]
    public class ProductSellByQuantityInGroupTests
    {
        [TestMethod]
        public void ProductSellByQuantityInGroup_EmptyTest()
        {
            // arrange
