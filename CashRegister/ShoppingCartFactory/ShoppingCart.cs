...
namespace CashRegister.ShoppingCartFactory
{
    public class ShoppingCart
    {
        //List of all product list 
        protected List<ProductSell> productSellList = new List<ProductSell>();

        //Discount coupen value
        ...
        public ShoppingCart(decimal discountCouponValue, decimal totalPriceDiscountThreshold)
        {
